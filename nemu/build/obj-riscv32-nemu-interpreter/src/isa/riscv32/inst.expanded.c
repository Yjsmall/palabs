...
static inline int check_reg_idx(int idx) {
    ...
    ((void)sizeof((idx >= 0 && idx < 32) ? 1 : 0), __extension__({ if (
   idx >= 0 && idx < 32
   ) ; else __assert_fail (
...
__attribute__((always_inline)) static inline void pattern_decode(const char *str, int len, uint64_t *key, uint64_t *mask, uint64_t *shift) {
        ...
        if (c != ' ') {
            do {
                if (!(c == '0' || c == '1' || c == '?')) {
                    ...
                    assert_fail_msg();
                    ((void)sizeof((c == '0' || c == '1' || c == '?') ? 1 : 0), __extension__({ if (
   c == '0' || c == '1' || c == '?'
   ) ; else __assert_fail (
   "c == '0' || c == '1' || c == '?'"
   , "/home/fisher/pa/nemu/include/cpu/decode.h", 63, __extension__ __PRETTY_FUNCTION__); }));
                }
            } while (0);
   ...
   "0"
   , "/home/fisher/pa/nemu/include/cpu/decode.h", 64, __extension__ __PRETTY_FUNCTION__); }));
        }
    } while (0);
finish:
    *key   = __key >> __shift;
...
__attribute__((always_inline)) static inline void pattern_decode_hex(const char *str, int len, uint64_t *key, uint64_t *mask, uint64_t *shift) {
        ...
        if (c != ' ') {
            do {
                if (!((c >= '0' && c <= '9') || (c >= 'a' && c <= 'f') || c == '?')) {
                    ...
                    extern void assert_fail_msg();
                    assert_fail_msg();
                    ((void)sizeof(((c >= '0' && c <= '9') || (c >= 'a' && c <= 'f') || c == '?') ? 1 : 0), __extension__({ if (
   (c >= '0' && c <= '9') || (c >= 'a' && c <= 'f') || c == '?'
   ) ; else __assert_fail (
   "(c >= '0' && c <= '9') || (c >= 'a' && c <= 'f') || c == '?'"
   , "/home/fisher/pa/nemu/include/cpu/decode.h", 88, __extension__ __PRETTY_FUNCTION__); }));
                }
            } while (0);
   ...
   "0"
   , "/home/fisher/pa/nemu/include/cpu/decode.h", 89, __extension__ __PRETTY_FUNCTION__); }));
        }
    } while (0);
finish:
    *key   = __key >> __shift;
...
static void decode_operand(Decode *s, int *rd, word_t *src1, word_t *src2, word_t *imm, int type) {
    ...
    *rd          = (((i) >> (7)) & ((1ull << ((11) - (7) + 1)) - 1));
    switch (type) {
        case TYPE_I:
            do {
                *src1 = (cpu.gpr[check_reg_idx(rs1)]);
            } while (0);
            do {
                *imm = ({ struct { int64_t n : 12; } __x = { .n = (((i) >> (20)) & ((1ull << ((31) - (20) + 1)) - 1)) }; (uint64_t)__x.n; });
            } while (0);
            break;
        case TYPE_U: do { *imm = ({ struct { int64_t n : 20; } __x = { .n = (((i) >> (12)) & ((1ull << ((31) - (12) + 1)) - 1)) }; (uint64_t)__x.n; }) << 12;
            } while (0);
            break;
        case TYPE_S:
            do {
            ...
            do {
                *src2 = (cpu.gpr[check_reg_idx(rs2)]);
            } while (0);
            do {
                *imm = (({ struct { int64_t n : 7; } __x = { .n = (((i) >> (25)) & ((1ull << ((31) - (25) + 1)) - 1)) }; (uint64_t)__x.n; }) << 5) | (((i) >> (7)) & ((1ull << ((11) - (7) + 1)) - 1));
            } while (0);
            break;
        case TYPE_N: break;
        default:
            do {
                ...
                "0"
                , "src/isa/riscv32/inst.c", 70, __extension__ __PRETTY_FUNCTION__); }));
                }
            } while (0);
    }
}
static int decode_exec(Decode *s) {
    s->dnpc = s->snpc;
    {
        ...
        do {
            uint64_t key, mask, shift;
            pattern_decode("??????? ????? ????? 100 ????? 00000 11", (sizeof("??????? ????? ????? 100 ????? 00000 11") - 1), &key, &mask, &shift);
            if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) {
                {
                    int    rd   = 0;
                    word_t src1 = 0, src2 = 0, imm = 0;
        ...
        do {
            uint64_t key, mask, shift;
            pattern_decode("??????? ????? ????? 000 ????? 01000 11", (sizeof("??????? ????? ????? 000 ????? 01000 11") - 1), &key, &mask, &shift);
            if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) {
                {
                    int    rd   = 0;
                    word_t src1 = 0, src2 = 0, imm = 0;
        ...
        do {
            uint64_t key, mask, shift;
            pattern_decode("0000000 00001 00000 000 00000 11100 11", (sizeof("0000000 00001 00000 000 00000 11100 11") - 1), &key, &mask, &shift);
            if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) {
                {
                    int    rd   = 0;
                    word_t src1 = 0, src2 = 0, imm = 0;
        ...
        do {
            uint64_t key, mask, shift;
            pattern_decode("??????? ????? ????? ??? ????? ????? ??", (sizeof("??????? ????? ????? ??? ????? ????? ??") - 1), &key, &mask, &shift);
            if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) {
                {
                    int    rd   = 0;
                    word_t src1 = 0, src2 = 0, imm = 0;
