            ...
            (fflush(
             ...
             fprintf(
                 stderr, "\33[1;31m"
                         ...
                         "\33[0m"
                         "\n",
                 addr, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x8000000 - 1), cpu.pc));
            extern FILE *log_fp;
            fflush(log_fp);
...
void init_mem() {
    ...
    do {
        printf("\33[1;34m"
               ...
               "\33[0m"
               "\n",
               "src/memory/paddr.c", 49, __func__, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x8000000 - 1));
        do {
            extern FILE *log_fp;
            extern _Bool
            log_enable();
