...
static void welcome() {
    do {
        printf("\33[1;34m"
               ...
               "\33[0m"
               "\n",
               "src/monitor/monitor.c", 28, __func__, "\33[1;32m"
                                                      "ON"
                                                      "\33[0m");
        do {
            extern FILE *log_fp;
    ...
    do {
        printf("\33[1;34m"
               ...
               "\33[0m"
               "\n",
               "src/monitor/monitor.c", 29, __func__);
        do {
            extern FILE *log_fp;
            extern _Bool
            log_enable();
...
static long load_img() {
    if (img_file ==
        ...
        do {
            printf("\33[1;34m"
                   ...
                   "\33[0m"
                   "\n",
                   "src/monitor/monitor.c", 49, __func__);
            do {
                extern FILE *log_fp;
                extern _Bool
                log_enable();
    ...
    do {
        if (!(fp)) {
            ...
            assert_fail_msg();
            ((void)sizeof((fp) ? 1 : 0), __extension__({ if (
   fp
   ) ; else __assert_fail (
   "fp"
   , "src/monitor/monitor.c", 54, __extension__ __PRETTY_FUNCTION__); }));
        }
    } while (0);
    fseek(fp, 0, 2);
    long size = ftell(fp);
    do {
        printf("\33[1;34m"
               ...
               "\33[0m"
               "\n",
               "src/monitor/monitor.c", 59, __func__, img_file, size);
        do {
            extern FILE *log_fp;
            extern _Bool
            log_enable();
    ...
    ((void)sizeof((ret == 1) ? 1 : 0), __extension__({ if (
   ret == 1
   ) ; else __assert_fail (
   "ret == 1"
   , "src/monitor/monitor.c", 63, __extension__ __PRETTY_FUNCTION__); }));
    fclose(fp);
    return size;
}
static int parse_args(int argc, char *argv[]) {
    ...
    int o;
    while ((o = getopt_long(argc, argv, "-bhl:d:p:", table, ((void *)0))) != -1) {
        switch (o) {
