...
extern locale_t      newlocale(int __category_mask, const char *__locale, locale_t __base) __attribute__((__nothrow__, __leaf__));
...
static void statistic() {
    ...
    do {
        printf("\33[1;34m"
               ...
               "\33[0m"
               "\n",
               "src/cpu/cpu-exec.c", 93, __func__, g_timer);
        do {
            extern FILE *log_fp;
            extern _Bool
            log_enable();
    ...
    do {
        printf("\33[1;34m"
               ...
               "\33[0m"
               "\n",
               "src/cpu/cpu-exec.c", 94, __func__, g_nr_guest_inst);
        do {
            extern FILE *log_fp;
            extern _Bool
            log_enable();
    ...
    if (g_timer > 0)
        do {
            printf("\33[1;34m"
                   ...
                   "\33[0m"
                   "\n",
                   "src/cpu/cpu-exec.c", 96, __func__, g_nr_guest_inst * 1000000 / g_timer);
            do {
                extern FILE *log_fp;
                extern _Bool
                log_enable();
        ...
        do {
            printf("\33[1;34m"
                   ...
                   "\33[0m"
                   "\n",
                   "src/cpu/cpu-exec.c", 98, __func__);
            do {
                extern FILE *log_fp;
                extern _Bool
                log_enable();
        ...
        case NEMU_ABORT:
            do {
                printf("\33[1;34m"
                       ...
                       "\33[0m"
                       "\n",
                       "src/cpu/cpu-exec.c", 130, __func__, (nemu_state.state == NEMU_ABORT ? "\33[1;31m"
                                                                                              "ABORT"
                                                                                              "\33[0m"
