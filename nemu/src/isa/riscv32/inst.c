...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)             \
    ...
    // INSTPAT("??????? ????? ????? ??? ????? 11011 11", jalr, I, R(rd) = s->pc + 4; s->dnpc = s->pc + imm);
    INSTPAT("0000000 00000 00000 000 00001 11011 11", jalr, I, s->pc = src1 + imm; R(rd) = s->pc +4);
    // INSTPAT("0000000 00000 00000 000 00001 11011 11", ret, I, s->pc = src1 + imm; R(rd) = s->pc +4);
