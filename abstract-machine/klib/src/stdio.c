...
static void put_literal_(putter_t put, void *buf, const char *str,
...
static void itoa_(putter_t put, char *buf, int num, int base, size_t *p_idx,
...
static void utoa_(putter_t put, char *buf, unsigned int num, int base,
...
static int vsnprintf_(putter_t put, char *buf, const size_t maxlen,
